...
from _6_cvp_attack_paper._1_adaptive_attacks.all_adaptive_attacks import Adaptive_FGSM_Attack, Adaptive_i_FGSM_Attack, Adaptive_PGD_Attack, Physical_PGD_Attack
...
def main_sub(
    ...
    my_attack = CVP_Attack(my_data, cav_detected_model)
