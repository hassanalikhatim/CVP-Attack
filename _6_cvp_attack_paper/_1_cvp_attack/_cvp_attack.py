    ...
    def attack(
        ...
        **kwargs
        ...
        for iteration in range(iterations):
            ...
            # We only want to keep the inflow perturbations 
            # outflow state will be generated later
            corrected_perturbations = corrected_perturbations[:,:,:,:,:int(history)]
            
            # We want all the perturbations to be equal. 
            # Averaging is not a good idea because different {x_input} will require different clipping values.
